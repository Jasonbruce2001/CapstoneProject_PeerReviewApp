        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AssignmentVersions_Assignments_ParentAssignmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserAssignmentVersion", x => new { x.StudentsId, x.VersionsId });
                    table.ForeignKey(
                        name: "FK_AppUserAssignmentVersion_AspNetUsers_StudentsId",
                        column: x => x.StudentsId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubmitterId = table.Column<string>(type: "varchar(255)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AssignmentGradeId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserAssignmentVersion_VersionsId",
                table: "AppUserAssignmentVersion",
                column: "VersionsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssignmentVersions_ParentAssignmentId",
                table: "AssignmentVersions",
